...
let rental=new Rental("tesla","mercy",30,25)
console.log(Rental)
...
class Question{
    ...
    checkAnswer(usersanswer){
        this.usersanswer===this.usersanswer
        
    }
}
// console.log(Question)
let question2 = new Question("man","a or b","b",true)
console.log({Question})
...
// correct using the checkAnswer method of the Question class, and updates the score if the answer is correc t
...
//     addquestion(object=+this.questions)
//     nextquestion(questions=+his.currentquestionIndex)
//     submitAnswer=(this.usersanswer===this.usersanswer)
// }
